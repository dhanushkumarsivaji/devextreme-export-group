...
import { DataGrid, Column, Grouping, Summary, GroupItem, TotalItem, Export, GroupPanel } from 'devextreme-react/data-grid';
...
const onExportDataGrid = (e) => {
  ...
  exportDataGrid({
    ...
    for(let i = dataGridRange.to.row; i >= dataGridRange.from.row; i--) {
      ...
      worksheet.getRow(i).outlineLevel = undefined;
    }
...
const App = () => {
  return (
    <DataGrid dataSource={orders} showBorders={true}  onExporting={onExportDataGrid}>
            <Export enabled={true}  />
      ...
      <Column caption="City" dataField="CustomerStoreCity" groupIndex={1} />
      <Column caption="State" dataField="CustomerStoreState" />
      <Column
